...
<template>
  <!-- Loading State -->
  <div v-if="isLoading" class="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-slate-900 text-white p-8 text-center">
  ...
  <div v-else>
    ...
    <div v-if="role === 'UNAPPROVED'" class="fixed inset-0 z-50 flex flex-col items-center justify-center bg-sy-700 text-white p-8 text-center">
      <h1 class="text-4xl font-bold mb-4">models.com.stefvisser.springyield.Account Pending Approval</h1>
      ...
      <button @click="logout" class="mt-8 bg-white hover:bg-gray-200 text-sy-700 font-bold py-2 px-6 rounded-lg shadow-md">
        Logout
      </button>
    </div>
    ...
    <div v-else class="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gray-800 text-white p-8 text-center">
        ...
        <button @click="logout" class="mt-8 bg-sky-500 hover:bg-sky-600 text-white font-bold py-2 px-6 rounded-lg shadow-md">
        Logout
      </button>
    </div>
  </div>
